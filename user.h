...
public:
    ...
    bool purchaseProduct(const QString& productId, QList<Product>& allProducts);
    ...
    bool publishProduct(const QString& productName, double price, const QString& description,
                        const QString& category, QList<Product>& allProducts, bool isVirtual = false);
    bool publishVirtualProduct(const QString& productName, double price, const QString& description, QList<Product>& allProducts);
    QList<QString> viewSoldProducts(const QList<Product>& allProducts);
    QList<QString> viewSalesStatus(const QList<Product>& allProducts);
